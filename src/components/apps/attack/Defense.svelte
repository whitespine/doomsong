<script>
    ...
    async function submit(e) {
        ...
        // Deduct the footing!
        defender.update({
            "system.footing.value":
                defender.system.footing.value - app.flow.footing_spent,
        });
...
<form onsubmit={submit}>
    <div class="container">
        <div class="row">
            <div class="col-5">
                <h1 class="col clip-text">{attacker.name}</h1>
            </div>
            <div class="col-2">
                <h1>vs</h1>
            </div>
            <div class="col-5">
                <h1 class="col clip-text">{defender.name}</h1>
            </div>
        </div>
        <div class="row">
            <div class="col">
